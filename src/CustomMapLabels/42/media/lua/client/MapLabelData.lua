...
data.ModMapLabels = {
	...
	["\\CamdenCountyB42"] = {
		{ key = "MapLabel_CamdenCounty",          x = 16200,  y = 11456, type = "Town", scale = 6.5 },
		{ key = "MapLabel_Alton",          x = 15543,  y = 9949, type = "Town", scale = 4.5 },
		{ key = "MapLabel_CampLynn",          x = 17315,  y = 9446, type = "Town",scale = 2.5},
		{ key = "MapLabel_DixieHomes",          x = 15161,  y = 9487, type = "Town",scale = 2.0},
		...
		{ key = "MapLabel_Suggs",          x = 17100,  y = 11650, type = "Town", scale = 4.0 },
		{ key = "MapLabel_Trenton",          x = 16274,  y = 9392, type = "Town",scale = 2.5},
